...
class MyFrame(wx.Frame):
    def __init__(self):
        ...
        self.Text1 = wx.StaticText(panel, -1, u"学号", pos=(10, 10))
        self.Text2 = wx.StaticText(panel, -1, u"姓名", pos=(10, 40))
        self.Text3 = wx.StaticText(panel, -1, u"年龄", pos=(10, 70))
        # self.Text4 = # wx.StaticText(panel, -1, u"到", pos=(100, 70))
        self.Text5 = wx.StaticText(panel, -1, u"性别", pos=(10, 100))
        self.Text6 = wx.StaticText(panel, -1, u"班级", pos=(200, 10))
        self.Text7 = wx.StaticText(panel, -1, u"学院", pos=(200, 40))
        self.Text8 = wx.StaticText(panel, -1, u"地址", pos=(200, 70))

        # self.Ssex = wx.ComboBox(panel, -1, "", pos=(250, 100), choices=[u"Student", u"Teacher", u"Course", u"SC", u"TC"])
        ...
        self.buttonSearch = wx.Button(panel, label=u"查询", pos=(400, 10), size=(100, 27))
        self.buttonSearch.Bind(wx.EVT_BUTTON, self.searchSql)

        self.buttonSearch = wx.Button(panel, label=u"插入", pos=(400, 40), size=(100, 27))
        self.buttonSearch.Bind(wx.EVT_BUTTON, self.insertSql)

        self.buttonSearch = wx.Button(panel, label=u"更新", pos=(400, 70), size=(100, 27))
        self.buttonSearch.Bind(wx.EVT_BUTTON, self.updateSql)

        self.buttonSearch = wx.Button(panel, label=u"删除", pos=(400, 100), size=(100, 27))
        self.buttonSearch.Bind(wx.EVT_BUTTON, self.deleteSql)

        self.buttonSearch = wx.Button(panel, label=u"Course", pos=(520, 10), size=(100, 27))
        self.buttonSearch.Bind(wx.EVT_BUTTON, self.c2Course)

        self.buttonSearch = wx.Button(panel, label=u"Student", pos=(520, 40), size=(100, 27))
        self.buttonSearch.Bind(wx.EVT_BUTTON, self.c2Student)

        self.buttonSearch = wx.Button(panel, label=u"Teacher", pos=(520, 70), size=(100, 27))
        self.buttonSearch.Bind(wx.EVT_BUTTON, self.c2Teacher)

        self.buttonSearch = wx.Button(panel, label=u"SC", pos=(520, 100), size=(100, 27))
        self.buttonSearch.Bind(wx.EVT_BUTTON, self.c2Student)

        self.buttonSearch = wx.Button(panel, label=u"TC", pos=(520, 100), size=(100, 27))
        self.buttonSearch.Bind(wx.EVT_BUTTON, self.c2Student)

    
    def c2Teacher(self, event):
        self.Text1.SetValue("Tid");
        self.Text2.SetValue("Tname");
        self.Text3.SetValue("Tage");
        self.Text4.SetValue("Tsex");
        self.Text5.SetValue("Tdept");
        self.Text6.SetValue("Taddr");
        self.Text7.SetValue("Tlevel");

    def c2Course(self, event):
        self.Text1.SetValue("Sid");
        self.Text2.SetValue("Cid");
        self.Text3.SetValue("OutRatio");
        self.Text4.SetValue("Test1Score");
        self.Text5.SetValue("Test2Score");
        self.Text6.SetValue("Test3Score");
        self.Text7.SetValue("Test4Score");

    def c2Student(self, event):
        self.Text1.SetValue(u"学号");
        self.Text2.SetValue("Tname");
        self.Text3.SetValue("Tage");
        self.Text4.SetValue("Tsex");
        self.Text5.SetValue("Tdept");
...
######################################################
    ...
    def deleteSqlTeacher(self, event):
        # display sql text:
        sqlDisplay = "delete FROM Student WHERE"
    ...
    def insertSqlTeacher(self, event):
        self.ValSid = self.SidP.GetValue()
        self.ValSname = self.SnameP.GetValue()
        self.ValSage1 = self.Sage2.GetValue()
        # self.ValSage = self.Sage.GetValue()
    ...
    def updateSqlTeacher(self, event):
        self.ValSid = self.Sid.GetValue()
        self.ValSname = self.Sname.GetValue()
        self.ValSage1 = self.Sage1.GetValue()
        # self.ValSage = self.Sage.GetValue()
    ...
    def searchSqlTeacher(self, event):
        # display sql text:
        sqlDisplay = "SELECT * FROM Student WHERE"
...
######################################################
    ...
    def deleteSqlCourse(self, event):
        # display sql text:
        sqlDisplay = "delete FROM Student WHERE"
    ...
    def insertSqlCourse(self, event):
        self.ValSid = self.SidP.GetValue()
        self.ValSname = self.SnameP.GetValue()
        self.ValSage1 = self.Sage2.GetValue()
        # self.ValSage = self.Sage.GetValue()
    ...
    def updateSqlCourse(self, event):
        self.ValSid = self.Sid.GetValue()
        self.ValSname = self.Sname.GetValue()
        self.ValSage1 = self.Sage1.GetValue()
        # self.ValSage = self.Sage.GetValue()
    ...
    def searchSqlCourse(self, event):
        # display sql text:
        sqlDisplay = "SELECT * FROM Student WHERE"
